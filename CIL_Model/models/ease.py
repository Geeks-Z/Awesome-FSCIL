...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_dataset = data_manager.get_dataset(np.arange(self._known_classes, self._total_classes), source="train", mode="train", kshot=self.args["kshot"])
        ...
        self.train_dataset_for_protonet = self.train_dataset
