...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.train_loader_for_protonet = DataLoader(self.train_dataset, batch_size=self.batch_size,
            ...
            with torch.no_grad():
                ...
                for x_id in range(len(inputs)):
                    ...
                    while True:
                        ...
                        cur_logits = self._network.backbone(cur_feature, fc_only=True)["logits"][:,
                                     :self._total_classes]
