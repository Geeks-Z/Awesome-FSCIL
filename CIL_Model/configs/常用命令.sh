...
nohup ./configs/train_coda_prompt_dino.sh > ../results/CODA-Prompt-DINO-NoShuffle-1993-A40.out 2>&1 &
...
nohup ./configs/train_finetune_dino.sh > ../results/FineTune-DINO-NoShuffle-1993-A40.out 2>&1 &
...
nohup ./configs/train_l2p_dino.sh > ../results/L2P-DINO-NoShuffle-1993-A40.out 2>&1 &
...
nohup ./configs/train_lae_dino.sh > ../results/LAE-DINO-NoShuffle-1993-A40.out 2>&1 &
...
nohup ./configs/train_simplecil_dino.sh > ../results/SimpleFSCIL-DINO-NoShuffle-1993-A40.out 2>&1 &
