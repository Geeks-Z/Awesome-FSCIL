...
from utils.data import iCIFAR10, iCIFAR100, iImageNet100, iImageNet1000, iCIFAR224, iImageNetR,iImageNetA,CUB, objectnet, omnibenchmark, vtab, iMiniImageNet
import random
...
class DataManager(object):
    ...
    def _select(self, x, y, low_range, high_range, kshot=None):
        ...
        if isinstance(kshot, int) and low_range>=self.args['init_cls']:
            ...
            idxes = idxes[:kshot]
            logging.info('select idxes for few shot class {}: '.format(low_range) + str(idxes))
